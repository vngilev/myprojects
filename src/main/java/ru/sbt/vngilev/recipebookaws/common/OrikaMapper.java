...
import ru.sbt.vngilev.recipebookaws.dto.IngredientDto;
import ru.sbt.vngilev.recipebookaws.dto.RecipeDto;
import ru.sbt.vngilev.recipebookaws.dto.FoodStuffDto;
import ru.sbt.vngilev.recipebookaws.entity.Ingredient;
...
public class OrikaMapper implements Mapper {
    ...
    protected void register(MapperFactory mapperFactory) {
        ...
        mapperFactory.classMap(FoodStuffDto.class, Foodstuff.class)
